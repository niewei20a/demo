...
<head>
    ...
    <script type="text/javascript">
        function ajaxFun() {
            $.get("AjaxServlet", {
                ...
                $.each(data, function (i, d) {
                    $("#tabletest tbody").append("<tr><td>" + d.id + "</td><td>" + d.sex + "</td><td>" + d.username + "</td><td>" + d.birthday + "</td><td>" + d.address +
                        "</td><td>" + "<button cid =\"" + d.id + "\" onclick='updateUser(this)'>更新</button><button cid =\"  " + d.id + "  \" onclick='deleteUser(this)'>删除</button>" + "</td></tr>");
                });
            }, 'json');
        };
        ...
        function ajaxAdd() {
            art.dialog({
                title: '添加用户',
                content: '<form id = "form1" >姓名：<input type="text" id="username" name="username" />性别：<input type="radio" name="sex" id="sex" value="1" /> 男\n' +
        ...
        function updateUser(obj) {
            ...
            art.dialog({
                title: '更新用户',
                content: '<form id = "form2" >姓名：<input type="text" id="username" name="username" />性别：<input type="radio" name="sex" id="sex" value="1" /> 男\n' +
                    '<input type="radio" name="sex" id = "sex" value="2" /> 女</br>地址：<input type="text" id = "address" name ="address">' +
                    '生日：<input type="date" id="birthday" name = "birthday"></form>',
                width: 200,
                height: 200,
